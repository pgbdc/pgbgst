...
<html>
    ...
    <title>Vendor Txn</title>
     ...
     <script src="http://ajax.aspnetcdn.com/ajax/jquery.ui/1.8.22/jquery-ui.js"></script>
        ...
        $(document).ready(function(){
          ...
          $('#reg_vendor').change(function(){
        	if($('#reg_vendor').val()=='Y'){

              $('#gst_num').html(''); 
               $.getJSON("{{ url('/utils/getgstnvendorlist') }}",
       
                   function(data){
               $.each(data, function(i, value) {
        
             $('#gst_num').append($('<option>').text(value.gstn_num + " - "+value.vendor_name).attr('value', value.gstn_num));
  ...
  <body>
    ...
    <div class="form-group ">
        <div class="col-lg-12">
             <form id="vendor_txn" name="vendor_txn" action="{{ url('/vendortxn')}}" method="post">
              {{ csrf_field() }}
                   <div class="panel panel-default panel-primary">
                       <div class="panel-heading"><b>Vendor Transaction Details</b></div>
                         <div class="panel-body">
                              <div class="col-lg-4" >
                                  <label> Registered Vendor * :</label>
                                        <select class="form-control form-inline"  id="reg_vendor" name="reg_vendor" onChange="check(this)"; value="{{old('reg_vendor')}}" required>
                            ...
                            <div class="col-lg-4">
                                          ...
                                          <input class="form-control form-inline" type ="text" id="invoice_dt" name="invoice_dt" value="{{old('invoice_dt')}}" required>
                                    </div>
                           <div class="col-lg-4">
                           ...
                           <div class="col-lg-3">
                            ...
                            <div class="col-lg-3">
                                          ...
                                          <input class="form-control form-inline" type ="text" name="igst">
                                       </div>  
                           <div class="col-lg-3" >
                                  <label></label>
